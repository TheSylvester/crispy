 ...
 */
function parseCliArgs(): { sessionFile?: string; decisionsFile?: string; projectId?: string; deadlineMs?: number } {
  const opts: { sessionFile?: string; decisionsFile?: string; projectId?: string; deadlineMs?: number } = {};

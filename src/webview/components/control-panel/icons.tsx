...
export function SendIcon({ className, ...props }: IconProps): React.JSX.Element {
  return (
    <svg className={className} width="14" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
